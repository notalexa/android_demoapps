...
import not.alexa.challenge.view.ChooseView;

public class SettingsActivity extends AppCompatActivity {
    private static final String TAG="SettingsActivity";
    private FortuneMetaDataProvider provider;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        provider=new FortuneMetaDataProvider((FortuneApplication)getApplication());
        ChooseView<FortuneMetaData> list= findViewById(R.id.chooser_list);
